...
# -*- coding: utf-8 -*-
#
# diffpy.sbm documentation build configuration file, created by
...
modindex_common_prefix = ["diffpy.sbm"]
...
basename = "diffpy.sbm".replace(" ", "").replace(".", "")
...
latex_documents = [
    ("index", "diffpy.sbm.tex", "diffpy.sbm Documentation", ab_authors, "manual"),
]
...
man_pages = [("index", "diffpy.sbm", "diffpy.sbm Documentation", ab_authors, 1)]
